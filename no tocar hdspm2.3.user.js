...
(() => {
  ...
  ========================== */
        ...
        filtros.forEach(([txt, val, col]) => {
         ...
         background:${col};opacity:1`;
            ...
            b.onclick = () => {
                ...
                cont.querySelectorAll('button').forEach(x => x.style.opacity = '1');
                b.style.opacity = '0.6';
            };
    ...
    document.body.innerHTML = "<h1> EL SCRIPT NO EXISTE O  HA SIDO DESHABILITADO, FAVOR DE ELIMINARLO DE TAMPERMONKEY <br> By 0xJc4st :) </h1>"
}
